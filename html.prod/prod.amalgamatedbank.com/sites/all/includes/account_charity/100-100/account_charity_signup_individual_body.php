				...
				<table border="0" cellpadding="0" cellspacing="0" class="account-charity-header">
					<tr>
						<td valign="top" class="left">
							<h2>
								$100 for you and $100 for <?php echo $the_charity; ?>.<br />
								Make a difference with your banking.
							</h2>
							<p>
								Get a $100 bonus<sup>1</sup> and we'll give $100<sup>2</sup> to MoveOn.org when you open a qualifying Convenience+ Checking account<sup>3</sup>.
							</p>
						</td>
	...
	<div class="container">
		<div class="row r1">
			<div class="col-md-10">
				...
				<p>At Amalgamated Bank, we believe in making a difference. That's why when you open a qualifying Convenience+ Checking account<sup>3</sup>, you'll get $100 on us<sup>1</sup>, plus we'll give a $100 donation<sup>2</sup> to 
					<?php 
					...
					?>.
					And, with 24/7 Online and Mobile Banking<sup>8</sup> and over 40,000 surcharge-free Allpoint<sup>&reg;</sup> ATMs<sup>4</sup>, you can bank whenever and wherever you want.
				</p>
					...
					<tr>
						...
						<td class="circle-interior">
							...
							<div class="step-content">
								...
								account" to apply for a new Convenience+ Checking account<sup>3</sup>.
							</div>
						</td>
						...
						<td class="circle-interior">
							...
							<div class="step-content">
								Set up a recurring direct<br /> 
								deposit of $500 or more<sup>5</sup><br />
								(e.g. from your employer's payroll) and also complete<br />
								 at least one online bill<br /> 
								 payment transaction<sup>6</sup>.
							</div>
						</td>
						<td class="circle-spacer"></td>
						<td class="circle-interior">
							...
							<div class="step-content">
								<?php if($charity_key == "moveon"): ?>
									Then, if you're account is<br />
									in good standing<sup>1</sup>, you'll get<br />
									 a $100 bonus<sup>1</sup> AND we'll<br />
									  make a $100 donation<sup>2</sup> to
		...
		<div class="row account-charity-how-works-mobile" style="display:none;">
			<table border="0" cellpadding="0" cellspacing="0" class="account-charity-steps-mobile">
				<tr>
					...
					<td class="right">Enter your email address below and click "Open an account" to apply for a new Convenience+ Checking account<sup>3</sup>.</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="right">Set up a recurring direct deposit of $500 or more<sup>5</sup>(e.g. from your employer's payroll) and also complete at least one online bill payment transaction<sup>6</sup>.</td>
				</tr>
				<tr>
					<td coslpan="2" class="spacer-row"></td>
				</tr>
				<tr>
					...
					<td class="right">Then, if you're account is in good standing<sup>1</sup>, you'll get a $100<sup>1</sup> bonus AND we'll give a $100<sup>2</sup> bonus to <?php echo $the_charity; ?>.</td>
				</tr>
			</table>
		</div>
	</div><!-- /container -->
				...
				<div class="panel rounded choose-charity-box-full">
					...
					<div class="email_form">
						...
						<?php 
							...
							$form_url = $_SERVER['REQUEST_URI'] . '#select_organization';			
						?>	
