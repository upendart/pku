...
(function($, Drupal){
  ...
  Drupal.behaviors.bootstrapAnchors = {
    ...
    bootstrapAnchor: function (element) {
     //JK: May have to comment out this line or correct since it's causing anchor links not to work.  Instead of altering, the solution we implemented was going to Appearance --> Settings --> Amalgamated Reborn --> JavaScript --> Anchors --> Uncheck Fix anchor positions
